<h2>Plot assistant - Graph visualizaton framework for the industrial cotrol systems</h2> <br />  Graph visualization framework as a custom feature interfaced with industrial SCADA-based HMI
